 ...
 *
 * Disassembly of ./SSDT-4-PegSsdt.aml, Mon Aug 23 21:16:16 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000027E9 (10217)
 *     Revision         0x02
 *     Checksum         0x46
 *     OEM ID           "Intel"
...
DefinitionBlock ("", "SSDT", 2, "Intel", "PegSsdt", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.GDVI, MethodObj)    // 0 Arguments
        ...
        Method (GPPR, 2, NotSerialized)
        {
            ...
            ElseIf ((Arg1 == One))
            {
                If ((Arg0 == Zero))
                {
                    ...
                    If ((\_SB.PCI0.LPCB.EC0.GDVI () == 0x10DE))
                    {
                        Sleep (0x64)
                    }
                    Else
